        ...
        <div className="mx-6 py-9 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 space-x-20">
            <div className="">
              ...
              <p>
                MindWellness is a comprehensive online platform designed to
                empower individuals to take control of their mental health. Our
                website offers a user-friendly and confidential environment
                where users can assess their mental health status, access
                resources, and explore personalized remedies to improve their
                well-being.
              </p>
            </div>
            <div className="">
            ...
            <div className="">
              ...
              <p className="flex items-center justify-center md:justify-start mb-4">
                <div
                  ...
                  className="w-4 mr-4"
                  role="img"
                  xmlns="http://www.w3.org/2000/div"
                  viewBox="0 0 576 512"
                >
                  <path
                    fill="currentColor"
