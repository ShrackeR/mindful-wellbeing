        ...
        <main className="container mx-auto p-4 mt-4 mb-4">
          ...
          <section className="mb-8">
            <div className="bg-white p-6 rounded-lg shadow-lg flex">
              ...
              <div className="w-1/2 pl-6">
                ...
                <p>
                  If you experience psychoticism symptoms, it's crucial to
                  consult with a mental health professional or therapist. They
                  can provide assessment and appropriate treatment options.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="mb-8">
            <div className="bg-white p-6 rounded-lg shadow-lg flex">
              ...
              <div className="w-1/2 pl-6">
                ...
                <p>
                  Grounding techniques can help you stay connected to reality.
                  Try techniques like deep breathing, focusing on sensory
                  experiences, or using grounding exercises recommended by a
                  therapist.
                </p>
              </div>
            </div>
          ...
          <section className="mb-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p>
                ...
                necessary to manage psychotic symptoms. Consult with a
                healthcare provider for medication options.
              </p>
            </div>
          </section>
          ...
          <section className="mb-8">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              ...
              <p>
                Prioritize self-care practices, including a consistent sleep
                schedule, a balanced diet, and stress reduction techniques.
