  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="container mx-auto p-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex">
            ...
            <div className="w-1/2 pl-6">
              ...
              <p>
                ...
                can help reduce OCD-related anxiety. Mindful awareness can also
                improve your ability to manage intrusive thoughts.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold mb-2">Self-Help Techniques</h2>
            <p>
              Learn self-help techniques to manage OCD, such as journaling,
              creating exposure hierarchies, and implementing structured routines.
            </p>
          </div>
        </section>
      </main>
