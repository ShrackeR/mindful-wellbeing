  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <header className="bg-blue-500 p-4 text-white">
        <h1 className="text-3xl font-semibold">Phobic Anxiety Remedies</h1>
      </header>
      <main className="container mx-auto p-4">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg flex">
            ...
            <div className="w-1/2 pl-6">
              ...
              <p>
                ...
                with a therapist. Cognitive-behavioral therapy (CBT) and exposure
                therapy are effective treatments for phobias.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-white p-6 rounded-lg shadow-lg flex">
            ...
            <div className="w-1/2 pl-6">
              <h2 className="text-2xl font-semibold mb-2">Exposure Therapy</h2>
              <p>
                Exposure therapy involves gradual and controlled exposure to the
                phobic trigger. Over time, this can reduce anxiety responses and
        ...
        <section className="mb-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            ...
            <p>
              Practice relaxation techniques, such as deep breathing exercises and
              progressive muscle relaxation, to reduce anxiety and stress related to
              phobias.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          <div className="bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-semibold mb-2">Self-Help Strategies</h2>
            <p>
              Learn self-help strategies like creating a fear hierarchy, setting
              achievable goals, and tracking your progress in overcoming phobias.
            </p>
          </div>
        </section>
      </main>
